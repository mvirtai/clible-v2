...
class AnalyticService:
    ...
    def _align_verses(self, verses_a: list[dict], verses_b: list[dict]) -> list[dict]:
        ...
        Args:
            verses_a: Verses for translation A.
            verses_b: Verses for translation B.

        Returns:
            List of aligned rows with text_a/text_b (missing side is empty string),
            ordered by (book_id, chapter, verse).
        """
    ...
    def compare_translations(
        ...
        Args:
            reference: Bible reference string ("John 3:16" or "John 3:16-18").
            translation_a: Left-side translation ID.
            translation_b: Right-side translation ID.

        Returns:
            Dict with:
                - reference, translation_a, translation_b
                - aligned_verses: list of verse rows with similarity and exact_match
                - summary: aggregate similarity stats
        """
