...
1. Read the [project overview](/architecture/project-overview) for current status and what is done
2. Read the [roadmap](/roadmap) for what comes next
3. Re-read the [architecture overview](/architecture/overview) before touching any layer boundaries
