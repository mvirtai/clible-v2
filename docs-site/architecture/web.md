...
For request/response shapes of the documented endpoints, see the [API reference](/api/reference) (OpenAPI may not list every AI variant; refer to `server.ts` for the full set).
