...
See [Web architecture](/architecture/web) for the full web integration details.
...
See the architecture decision records for the rationale behind key decisions:

- [ADR-001](/architecture/adr/001-offline-first-sqlite) — Offline-first with SQLite for verse data
- [ADR-002](/architecture/adr/002-layered-architecture) — Strict layer separation
- [ADR-003](/architecture/adr/003-xml-seed-parsers) — XML seed parsers instead of a live API
- [ADR-004](/architecture/adr/004-postgres-for-user-data) — PostgreSQL for user data in the web layer
