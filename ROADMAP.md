...
Current status and direction for the project. For implementation detail, see `docs/PROJECT_OVERVIEW.md`.
...
The original phase-based development plan (tickets 0–6) is preserved at `docs/archive/PLAN.md` for reference.
